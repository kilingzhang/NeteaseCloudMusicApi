...
class Snoopy
{
    ...
    var $host = "music.163.com"; // host name we are connecting to
    ...
    var $agent = "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/42.0.2311.135 Safari/537.36 Edge/13.10586"; // agent we masquerade as
    var $referer = "http://music.163.com/"; // referer info to pass
    ...
    {
//        $json = file_get_contents("http://www.xdaili.cn/ipagent/freeip/getFreeIps");
//        $data = json_decode($json, true);
//        $data = $data['RESULT'];
//        usort($data['rows'], 'sortByResponseTime');
        $num = rand(0, 9);
        $this->proxy_host = '210.29.26.250';
        $this->proxy_port = 80;
        $this->rawheaders['X-FORWARDED-FOR'] = '210.29.26.250';
        $this->rawheaders['X-Real-IP'] = '210.29.26.250';
    ...
    public function sortByResponseTime($rows1, $rows2)
    {

        if ($rows1['responsetime'] == $rows2['responsetime']) {
            return 0;
        } else {
            return $rows1['responsetime'] > $rows2['responsetime'] ? 1 : -1;
        }
    }
