 ...
 *
 * 调用例子:
 * http://i.music.163.com/comment/like?id=186016&type=0&cid=4956438 对应给晴天最热门的那条评论点赞
 *
 * 注意： 动态点赞不需要传入 id 参数，需要传入动态的 `threadId` 参数,
 * 如：`/comment/like?type=6&cid=1419532712&threadId=A_EV_2_6559519868_32953014`，
 *`threadId` 可通过 `/event`，`/user/event` 接口获取
 *
 */
class Like extends Controller
{
    protected $uri = 'https://music.163.com/weapi/v1/comment/like';
